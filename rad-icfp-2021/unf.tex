...
They serve as intermediate representations in the reverse-mode compilation pipeline (see Figure~\ref{fig:outline}).
...
Target UNF is an extension of Source UNF. 
...
We write this new term $(\widetilde{e_{2}})_{A}$. It is defined by induction on !e$_{2}$! as follows. 
