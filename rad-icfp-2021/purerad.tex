...
we do not want to keep all the lambda abstractions as this is costly. 
...
Using inlining as given in Figure~\ref{fig:optim} allows us to rewrite
...
we can use forward substitution on the other !e!$_{i}$ and we obtain
...
Next, we decompose this transformation into three simpler steps via a novel intermediate representation (UNF).