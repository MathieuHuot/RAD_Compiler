\begin{abstract}
    Reverse-mode differentiation is used for optimization, but it does not preserve purity of the underlying program which makes it notoriously harder to optimize.
    We present a reverse-mode differentiation on a purely functional language with array operations.  
    It is the first one to deliver a provably efficient, purely functional and denotationnally correct reverse-mode differentiation.
