\begin{abstract}
    ...
    We present a differentiable programming language which is the first to deliver on efficient, pure and parallel-friendly reverse-mode differentiation on
