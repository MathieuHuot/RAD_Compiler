...
\newcommand{\codekw}[1]{\texttt{\small\bfseries\color{blue!70!black}#1}}
...
\newcommand{\concatcomp}{\mathmakebox[2ex][s]{+\kern-1ex+\kern0.8ex}}
% \newcommand{\concatcomp}{+\kern-1.3ex+\kern0.8ex}
\newcommand{\CartSp}{\mathbf{CartSp}}
...
\newcommand{\plots}[1]{\mathcal{P}_{#1}}
\newcommand\seq[2][]{\left(#2\right)_{#1}}
\newcommand{\CSource}{\mathcal{C}_{Source}}
\newcommand{\CTarget}{\mathcal{C}_{Target}}
\newcommand{\NestA}{NAO}
\newcommand{\smartpara}[1]{\noindent \textbf{#1.}}
