...
\MH{actually I just need projection and a representing object for pairs, it might be weaker than Cartesian?}
\end{definition}
...
\MH{not too sure, should I say what a Cartesian concat is?}
\end{definition}
...
Might need to define on types as well to be clearer: It's an identity on type functor...}
