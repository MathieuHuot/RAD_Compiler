\begin{figure*}[t]
    ...
    !let G = (map2 * x$_{n+3}$ !\\
    && \quad\quad!(map2 (a,b.(!$\grad_\Gamma$!e$_{1}$)[a/x.b/y])  x$_{n+1}$  x$_{n+2}$)) in! \\
    && !((x$_{1}$,$\ldots$,x$_n$)$\widehat{+}$(reduce $\widehat{+}$ $\widehat{0}$ G),!\\
    ...
    \end{tabular}
    \vspace{-0.4cm}
    \caption{Transformation from Target UNF to Target}
