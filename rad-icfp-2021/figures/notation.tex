...
\begin{tabular}{|l c l|}
    \hline
    !let x1=e1,...,xn=en!  & \multirow{2}{*}{=} & !let x1=e1 in let x2=e2 in ...! \\
    !in e! && !let xn = en in e!\\ \hline
    $Id_\Gamma$ \quad\quad\quad ($\Gamma=x_:A_1,\ldots,x_n:A_n)$ & = & !fun! $(y_1:A_1,\ldots,y_n:A_n)$! -> !$(y_1,\ldots,y_n)$ \\ \hline
