\begin{figure*}[t]
    ...
    & $\mid$ & !T!$\times \ldots \times$!T! & \grammarcomment{$n$-tuples}\\ 
    ...
    & $\mid$ & !<e,$\ldots$,e>! & \grammarcomment{Tuples}\\
...
\\
    ...
    \\ 
    \begin{tabular}{c}
        for all $i$, $\Gamma$ $\vdash$ !e$_i$!: !T$_i$!
        \\\hline  
        $\Gamma \vdash$ !<e$_1$,$\ldots$,e$_n$>!: !T$_1\times\ldots\times$T$_n$!
    \end{tabular} \\
    \hline
    \end{tabular}
    \vspace{-0.4cm}
