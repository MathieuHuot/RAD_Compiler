\begin{figure*}[t]
    ...
    $\UNFSymbol$($\Gamma\vdash \pi_i$(!e!)) &=& $\UNFSymbol$(!e!)$\comp $ $\pi_i$ $\comp$ !proj!$_{\Gamma;A_1\times A_2;A_i}$ \\
    && $\pi_i$ seen as a unary operator\\
    ...
    $\UNFSymbol$($\Gamma\vdash $ !map2 (x,y.e$_1$) e$_2$ e$_3$!) &=& $\UNFSymbol$(!e$_2$!) $\comp$ $\widetilde{\UNFSymbol(e_3)}$ $\comp$ !map2!$_{\Gamma; x,y.e_1}$ $\comp$ \\
    && !proj!$_{\Gamma;\Array{\reals}{n},\Array{\reals}{n};\Array{\reals}{n}}$ \\ 
    ...
    \hline 
    \end{tabular}
    \caption{Transformation from Source to Source UNF}
